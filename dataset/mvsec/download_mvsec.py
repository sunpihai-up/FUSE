...
if __name__ == "__main__":
    ...
    # url = "https://drive.google.com/uc?id=1pCIyFm8vFgUs60O-mvFiDR8VK2gkleSi"
    # name = "outdoor_day1_gt.hdf5"
    # download_file(name, url, '/datadrive')
    
    outdoor_day_dir = os.path.join(args.data_root, 'outdoor_day')
    outdoor_night_dir = os.path.join(args.data_root, 'outdoor_night')
    
    download_files(outdoor_day_urls, outdoor_day_dir)
    download_files(outdoor_night_urls, outdoor_night_dir)
